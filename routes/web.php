...
Route::group(['middleware' => ['auth','access:1']], function(){    
    ...
    Route::get('psak/detail/{data}',App\Http\Livewire\Psak\Detail::class)->name('psak.detail');
    Route::get('/psak/detail-employee/{data}', App\Http\Livewire\Psak\DetailEmployee::class)->name('psak.detail-employee');
});